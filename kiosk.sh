...
CLEAR_CMD='echo -ne "\033[?25l\033[2J\033[H\033[0;30m\033[40m"'
if ! grep -q '033\[?25l' /home/$KIOSK_USER/.bash_profile 2>/dev/null; then
  echo "$CLEAR_CMD" >> /home/$KIOSK_USER/.bash_profile
  echo -e "${GREEN}✓ Screen clear on login added${NC}"
else
  echo -e "${GREEN}✓ Already configured${NC}"
fi
