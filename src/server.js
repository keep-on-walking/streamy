...
app.get('/api/stream/:videoId', (req, res) => {
  ...
  const ff = spawn('ffmpeg', [
    '-loglevel', 'error',
    '-analyzeduration', '500000',  // 0.5s — enough to detect WebM, not too much buffering
    '-probesize', '200000',        // 200KB — enough for WebM EBML headers
    '-i', 'pipe:0',
    '-vn',
    '-c:a', 'libmp3lame',
    '-b:a', '128k',
    '-f', 'mp3',
    '-flush_packets', '1',         // flush output immediately, don't buffer
    'pipe:1',
  ]);
