...
class Player extends EventEmitter {
  ...
  async playTrack(track) {
    ...
    if (this.mpvProc && this.mpvProc.exitCode === null && this.ipcReady) {
    ...
    this.mpvProc = spawn('mpv', args, {
      ...
      env: { ...process.env, DISPLAY: process.env.DISPLAY || ':0', PIPEWIRE_RUNTIME_DIR: process.env.XDG_RUNTIME_DIR || '/run/user/1000', XDG_RUNTIME_DIR: process.env.XDG_RUNTIME_DIR || '/run/user/1000' },
    });
    ...
    // With --keep-open=yes, mpv only exits on crash/kill.
    // Normal end-of-track is handled via IPC end-file events.
