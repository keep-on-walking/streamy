...
class Player extends EventEmitter {
  ...
  async playTrack(track) {
    ...
    // Kill any orphaned loading screens from previous tracks
    try { require('child_process').execSync('pkill -f "streamy-loading.png" 2>/dev/null; true', { stdio: 'ignore' }); } catch {}
    this.loadingProc = null;
    this._showLoadingScreen();
