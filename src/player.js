...
class Player extends EventEmitter {
  ...
  async playTrack(track) {
    ...
    // In DRM mode, blank the framebuffer before killing the old mpv to hide the terminal
    if (this.mpvVO === 'drm') {
      try { require('child_process').execSync('echo 1 > /sys/class/graphics/fb0/blank 2>/dev/null; echo -ne "\\033[?25l\\033[2J" > /dev/tty1 2>/dev/null || true', { stdio: 'ignore' }); } catch {}
    }
