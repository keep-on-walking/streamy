...
class Player extends EventEmitter {
  ...
  async playTrack(track) {
    ...
    // In DRM mode, blank the console before killing the old mpv to hide the terminal
    if (this.mpvVO === 'drm') {
      try { require('child_process').execSync('setterm --blank force 2>/dev/null; echo -ne "\\033[9;0]\\033[14;0]" > /dev/tty1 2>/dev/null || true', { stdio: 'ignore' }); } catch {}
    }
